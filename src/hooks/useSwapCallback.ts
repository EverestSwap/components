...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@everestswap/sdk';
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'EverestRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'EverestRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
