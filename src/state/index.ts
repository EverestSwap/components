...
export const EVEREST_PERSISTED_KEYS: string[] = ['puser', 'plists', 'ptransactions', ...GELATO_PERSISTED_KEYS];

export const everestReducers = {
  papplication,
  ptransactions,
  pswap,
  plists,
...
const store = configureStore({
  reducer: everestReducers,
  middleware: [...getDefaultMiddleware({ thunk: false }), save({ states: EVEREST_PERSISTED_KEYS })],
  preloadedState: load({ states: EVEREST_PERSISTED_KEYS }),
});
